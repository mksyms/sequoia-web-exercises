...
// console.log(identity("this is confusing"));
...
console.log(first("I thought I needed to run and find somebody to love"));

function second(input) {
    return input.charAt(1);
}
console.log(second("I thought I needed to run and find somebody to love"));*/
...
//     var indexOfLastCharacter = numberOfCharacters - 1;
//     return input.charAt(indexOfLastCharacter)
//
// }
//
// console.log(last("whatever"));
